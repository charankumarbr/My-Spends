package in.phoenix.trackmyspends.controller;
...
import in.phoenix.trackmyspends.model.Currency;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mSelectedPosition == position) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                convertView.setBackgroundColor(TrackMySpends.APP_CONTEXT.getResources().getColor(R.color.colorAccent, null));
            } else {
                convertView.setBackgroundColor(TrackMySpends.APP_CONTEXT.getResources().getColor(R.color.colorAccent));
            }

        } else {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                convertView.setBackgroundColor(TrackMySpends.APP_CONTEXT.getResources().getColor(android.R.color.white, null));
            } else {
                convertView.setBackgroundColor(TrackMySpends.APP_CONTEXT.getResources().getColor(android.R.color.white));
            }
        }
