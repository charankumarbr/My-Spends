...
public final class AppUtil {
    ...
    public static void showToast(int stringId) {
        Toast.makeText(TrackMySpends.APP_CONTEXT, TrackMySpends.APP_CONTEXT.getString(stringId), Toast.LENGTH_SHORT).show();
    }

    public static void showToast(String message) {
        Toast.makeText(TrackMySpends.APP_CONTEXT, message, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void toggleKeyboard(boolean toShow) {
        InputMethodManager inputMethodManager = (InputMethodManager) TrackMySpends.APP_CONTEXT.getSystemService(Context.INPUT_METHOD_SERVICE);
        if (toShow) {
    ...
    public static ArrayList<Currency> getAllCurrency() throws IOException, JSONException {
        ...
        BufferedReader bufferedReader = new BufferedReader(
                new InputStreamReader(TrackMySpends.APP_CONTEXT.getAssets()
